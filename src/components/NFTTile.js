...
function NFTTile (data) {
  ...
  return (
      ...
      <Link  to={newTo}>
      <div className="w-64 h-64 ml-4 mb-4 mr-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-blue-900 dark:border-blue-500">
  ...
  <h5 className="text-xl font-semibold tracking-tight text-blue-600 text-blue ">{data.data.name}</h5>
        ...
        <span className="text-2xl text-white-900 text-white">{data.data.price} BNB</span>
